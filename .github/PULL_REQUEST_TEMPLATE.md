<!--
Thanks for contributing to agent-load-balancer! ðŸ™
...
- [ ] `fix:` â€” bug fix (no behavior change beyond the bug)
- [ ] `feat:` â€” new user-facing feature or capability
- [ ] `refactor:` â€” internal refactor (no behavior change, no API change)
- [ ] `docs:` â€” documentation only
- [ ] `chore:` / `ci:` / `build:` â€” tooling, CI, packaging
- [ ] `test:` â€” test-only change
...
<!--
agent-load-balancer is OpenSpec-first. If this PR changes observable behavior, requirements,
...
**codex-faithful** â€” i.e. preserve the exact wire format the real upstream
emits. Call out anything that intentionally diverges, and link the spec section
that records the divergence.
-->

- [ ] This PR includes / updates an OpenSpec change
- [ ] Not applicable â€” bug fix that matches the existing spec
- [ ] Not applicable â€” docs / CI / chore only
