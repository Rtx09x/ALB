...
if PROMETHEUS_AVAILABLE:
    ...
    rate_limit_hits_total = Counter(
        "alb_rate_limit_hits_total",
        "Rate limit hits",
        ["type"],
        registry=REGISTRY,
    )
    circuit_breaker_state = Gauge(
        "alb_circuit_breaker_state",
