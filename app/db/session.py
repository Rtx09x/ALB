...
def _postgres_async_engine_kwargs(url: str, *, background: bool) -> dict[str, object]:
    ...
    if _test_database_url_configured() and url.startswith("postgresql+asyncpg://"):
...
def _test_database_url_configured() -> bool:
    return bool(os.environ.get("ALB_TEST_DATABASE_URL") or os.environ.get("CODEX_LB_TEST_DATABASE_URL"))
