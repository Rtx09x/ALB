...
def test_postgres18_compose_upgrade_helper_is_digest_pinned() -> None:
    ...
    assert postgres["volumes"] == ["agent-load-balancer-postgres-data:/var/lib/postgresql"]
    ...
    assert upgrade["volumes"] == ["agent-load-balancer-postgres-data:/var/lib/postgresql"]
