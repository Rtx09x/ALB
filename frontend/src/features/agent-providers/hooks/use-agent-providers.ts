...
export function useAntigravityCliDiagnostics() {
  return useQuery({
    queryKey: ["agent-providers", "antigravity", "cli", "diagnostics"],
    queryFn: getAntigravityCliDiagnostics,
  });
}
