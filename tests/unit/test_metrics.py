...
def test_prometheus_metrics_defined_when_dependency_available(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    assert prometheus_module.requests_total.name == "alb_requests_total"
    assert prometheus_module.request_duration_seconds.name == "alb_request_duration_seconds"
    assert prometheus_module.active_connections.name == "alb_active_connections"
    assert prometheus_module.bridge_instance_mismatch_total.name == "alb_bridge_instance_mismatch_total"
    assert prometheus_module.bridge_instance_mismatch_total.labelnames == ("outcome",)
    assert prometheus_module.continuity_owner_resolution_total.name == "alb_continuity_owner_resolution_total"
    assert prometheus_module.continuity_owner_resolution_total.labelnames == ("surface", "source", "outcome")
    assert prometheus_module.continuity_fail_closed_total.name == "alb_continuity_fail_closed_total"
