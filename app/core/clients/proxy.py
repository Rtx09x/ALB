...
_RESPONSE_CREATE_TOOL_OUTPUT_OMISSION_NOTICE = (
    "[agent-load-balancer omitted historical tool output ({bytes} bytes) to fit upstream websocket budget]"
)
_RESPONSE_CREATE_IMAGE_OMISSION_NOTICE = "[agent-load-balancer omitted historical inline image to fit upstream websocket budget]"
...
_HELD_HALF_OPEN_PROBE_FLAG = "_alb_half_open_probe_held"
_HELD_HALF_OPEN_PROBE_BREAKER = "_alb_half_open_probe_breaker"
