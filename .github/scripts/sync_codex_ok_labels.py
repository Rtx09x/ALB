...
CODEX_OK_LABEL = "ðŸ¤– codex: ok"
CODEX_NEEDS_WORK_LABEL = "ðŸ¤– codex: needs work"
LEGACY_CODEX_LABELS = {"ðŸ¤– codex-ok"}
...
CODEX_CLEAN_RE = re.compile(
    r"(didn['â€™]t find any major issues|no major issues found|no major issues)",
    re.IGNORECASE,
)
...
REQUIRED_CHECKS_BY_REPO = {
    "rtx09x/agent-load-balancer": ALB_REQUIRED_CHECKS,
}
PR_TIMELINE_QUERY = """
