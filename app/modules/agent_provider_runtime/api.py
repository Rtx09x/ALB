...
@dashboard_router.get("/antigravity/cli/diagnostics", response_model=AntigravityCliDiagnosticsResponse)
async def get_antigravity_cli_diagnostics() -> AntigravityCliDiagnosticsResponse:
    result = await inspect_antigravity_cli()
    return AntigravityCliDiagnosticsResponse(
        ...
        print_supported=result.print_supported,
        print_timeout_supported=result.print_timeout_supported,
        conversation_supported=result.conversation_supported,
        add_dir_supported=result.add_dir_supported,
        sandbox_supported=result.sandbox_supported,
        model_supported=result.model_supported,
        plugin_supported=result.plugin_supported,
        error=result.error,
    )
