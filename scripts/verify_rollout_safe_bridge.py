...
def _parse_args() -> VerifyConfig:
    ...
    parser.add_argument("--host", default="agent-load-balancer.localtest.me")
    ...
    parser.add_argument("--rollout-namespace", default="agent-load-balancer-e2e")
    parser.add_argument("--rollout-context", default="kind-agent-load-balancer-local")
    parser.add_argument("--rollout-target", default="statefulset/agent-load-balancer-e2e-workload")
    parser.add_argument("--delete-owner-after-first-turn", action="store_true")
    parser.add_argument("--postgresql-pod", default="agent-load-balancer-e2e-postgresql-0")
    parser.add_argument("--postgresql-user", default="alb")
    parser.add_argument("--postgresql-database", default="alb")
    parser.add_argument("--postgresql-secret", default="agent-load-balancer-e2e-postgresql")
