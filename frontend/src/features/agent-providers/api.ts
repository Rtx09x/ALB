...
import {
  AntigravityCliDiagnosticsResponseSchema,
...
export function getAntigravityCliDiagnostics() {
  return get(`${AGENT_PROVIDERS_PATH}/antigravity/cli/diagnostics`, AntigravityCliDiagnosticsResponseSchema);
}
