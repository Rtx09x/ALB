...
_SECURITY_WORK_NO_AUTHORIZED_ACCOUNTS_MESSAGE = (
    ...
    "security work. agent-load-balancer is continuing with normal account selection; the upstream request may still fail until "
                        ...
                        format_sse_event(
                            _security_work_advisory_event(
                                ...
                                message=(
                                    ...
                                    "agent-load-balancer cannot safely switch accounts after this response has already started, "
