    ...
    payload = {
        ...
        "response_format": {
            ...
            "json_schema": {
                "name": "result_schema",
                "strict": True,
                # No additionalProperties: false â†’ strict-mode violation.
                "schema": {
                    "type": "object",
                    "properties": {"ok": {"type": "boolean"}},
                    "required": ["ok"],
...
async def test_v1_chat_completions_rejects_strict_function_tool_violation(async_client):
    ...
    payload; agent-load-balancer now does too.
    """
    payload = {
        "model": "gpt-5.2",
...
async def test_v1_chat_completions_strict_violation_param_uses_original_index(async_client):
    ...
    Index 0 is an invalid function tool (no ``name``) â€” the normalizer
...
async def test_v1_chat_completions_strict_violation_when_type_omitted_in_chat_tool(async_client):
    ...
    strict pre-validator must mirror that detection rule â€” anchoring on
    the presence of the ``function`` wrapper dict, not on a strict
    ``type == "function"`` check â€” otherwise type-omitted strict
    ...
    payload = {
        ...
        "tools": [
            {
                # No top-level ``"type"`` â€” the chat normalizer still
                ...
                "function": {
                    ...
                    "parameters": {
                        ...
                        "properties": {"city": {"type": "string"}},
                        "required": ["city"],
                        # No additionalProperties â†’ strict violation.
                    },
                    "strict": True,
                },
            }
